...
urlpatterns = [
    ...
    url(r'^email-verification/$',
        TemplateView.as_view(template_name="auth/email_verification.html"),
    ...
    url(r'^password-reset/$',
        TemplateView.as_view(template_name="auth/password_reset.html"),
        name='password-reset'),
    ...
    url(r'^user-details/$',
        TemplateView.as_view(template_name="dashboard/user_details.html"),
        name='user-details'),
    url(r'^password-change/$',
        TemplateView.as_view(template_name="auth/password_change.html"),
